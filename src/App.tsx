...
function App() {
  ...
  // Memoized statistics for display
  const stats = useMemo(
    () => [
      {
        label: "AI Tools",
        value: aiTools?.length?.toString() || "0",
        icon: Sparkles,
      },
      {
        label: "Categories",
  ...
  const handleSubmitTool = useCallback(() => {
    alert(
      "Thank you for your interest! Tool submission feature coming soon. Please check back later.",
    );
  }, []);
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      >
                        ...
                        <span className="text-sm font-medium">
                          Compare ({comparisonTools.length})
                        </span>
                      </button>
                    </div>
                  </div>
          ...
          element={
            <Suspense fallback={<LoadingSpinner />}>
              <ToolDetail
                ...
                onBack={() => navigate("/")}
                onAddToComparison={handleAddToComparison}
                isInComparison={comparisonTools.some(
                  (t) =>
                    t.id ===
