...
const contentItems: ContentItem[] = [
  ...
  },
  {
    ...
    type: 'article',
    category: 'Ethics',
    description: 'Understanding the ethical implications of using AI for content generation.',
    readTime: '15 min',
  ...
  },
  {
    ...
    description: 'Step-by-step guide to training and deploying your first AI model.',
    readTime: '25 min',
    difficulty: 'Advanced',
    rating: 4.7,
  ...
  },
  {
    ...
    description: 'Video tutorial on using AI tools for professional video editing.',
    readTime: '20 min',
    difficulty: 'Intermediate',
    rating: 4.5,
  ...
  },
  {
    ...
    type: 'guide',
    category: 'Text & Writing',
    description: 'Advanced techniques for writing effective prompts for AI models.',
    readTime: '18 min',
    difficulty: 'Intermediate',
    rating: 4.9,
  ...
  },
  {
    ...
    description: 'How AI is revolutionizing the design industry and creative workflows.',
    readTime: '12 min',
    difficulty: 'Beginner',
    rating: 4.4,
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-300 max-w-2xl mx-auto">
          Learn, explore, and master AI tools with our comprehensive guides, tutorials, and resources.
        </p>
      </div>
