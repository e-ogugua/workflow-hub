      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 w-8 h-8 text-ai-accent animate-ping opacity-20">
                <Sparkles className="w-8 h-8" />
              </div>
            </div>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold gradient-text leading-tight">
              Discover Premium
              <br />
        ...
        >
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-ai-primary to-ai-secondary rounded-2xl blur opacity-20 group-focus-within:opacity-40 transition-opacity duration-300" />
            <div className="relative glass-strong rounded-2xl p-2">
              <div className="flex items-center">
                <Search className="w-6 h-6 text-gray-400 ml-4 mr-4 group-focus-within:text-ai-primary transition-colors" />
                <motion.input
                  type="text"
                ...
                />
                <motion.button
                  className="mr-2 p-3 bg-gradient-to-r from-ai-primary to-ai-secondary rounded-xl hover:shadow-lg transition-all duration-300 flex items-center space-x-2"
        ...
        >
          {stats.map((stat) => (
            <motion.div
              key={stat.label}
              className="glass-strong rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 cursor-pointer group"
              variants={itemVariants}
              whileHover={{
                scale: 1.05,
                y: -5,
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-ai-primary/5 to-ai-secondary/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.div>
          ))}
        </motion.div>
